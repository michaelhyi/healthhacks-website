...
const SearchModal: React.FC<SearchModalProps> = ({ isOpen, onSelect, onClose }) => {
  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
      <div style={{ width: '50%', margin: '100px auto', backgroundColor: 'white', padding: '20px', color: 'black' }}>

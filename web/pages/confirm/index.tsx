  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (response) {
        ...
        if (!isWhitelisted || isPaid) {
          //|| JSON.parse(response).status !== "not-paid" || JSON.parse(response).status !== "paid") {
          router.push("/404");
          return;
        }
      } else {
              ...
              >
                ...
                <div>
                  <ApplicationInput
                    ...
                    setValue={(value) =>
                      setCForm({ ...cform, liability: value })
                    }
                ...
                <div>
                  <ApplicationInput
                    ...
                    setValue={(value) =>
                      setCForm({ ...cform, liabilityDate: value })
                    }

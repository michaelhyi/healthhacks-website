      ...
      <Fade delay={500} up distance="24px">
        <div className="flex flex-col items-center md:pb-16 md:pt-8 xl:pt-0 sm:pt-0 w-screen">
          ...
          <div className="max-w-lg">
            <h2 className="font-semibold text-4xl w-lg px-8 pt-8 text-left ">Please verify your email.</h2>
            <p className="font-normal text-base px-8 pt-2  md:text-base  sm:text-sm">
              We have sent an email to <strong>{email}</strong>.
              <br/> This can take a
              couple of minutes. Simply click the link to start your registration form.
            </p>
            ...
            <div className="flex md:items-center sm:items-start md:flex-row sm:flex-col px-8" >
              <button className="hover:cursor-pointer duration-500 hover:opacity-50 text-center bg-hh-purple text-white px-6 py-3 w-auto md:ml-0 sm:mx-0 my-4 rounded-xl text-sm font-medium" type="button" onClick={handleResendEmail}>
                Resend Email
              </button>
              <p className="text-left font-medium content-center md:text-base sm:text-sm sm:mx-0 md:mx-6">
                Having trouble? <a href="#" className="text-hh-purple hover:cursor-pointer duration-500 hover:opacity-50">Contact us.</a>
              </p>
            </div>
          </div>
        </div>

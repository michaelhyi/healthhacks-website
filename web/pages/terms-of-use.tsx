      ...
      <div className="mt-8 mb-24 mx-24">
        ...
        <div>
          ...
          <p className="font-thin text-sm">
            ...
            access to and use of the joinhealthhacks.com website as well as any
            ...
            States and have our registered office at 4032 Rampage Ln, Irvine, CA
            92620. You agree that by accessing the Site, you have read,
        ...
        <p className="font-thin text-sm">
          ...
          display, or performance, and theaccessing, downloading, or copying of
          your Contributions do not and will notinfringe the proprietary rights,
          ...
          and permissions to use and to authorize us, the Site, andother users
          of the Site to use your Contributions in any manner contemplatedby the
          Site and these Terms of Use. You have the written consent, release,
        ...
        <p className="font-thin text-sm">
          ...
          ("Submissions") provided by you tous are non-confidential and shall

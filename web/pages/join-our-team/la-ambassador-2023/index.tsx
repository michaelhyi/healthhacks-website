...
import { appendAmbassadorRow } from "../../../utils/helpers";
import {
...
const LAAmbassador = () => {
  ...
  const appendSpreadsheet = async (row: AmbassadorRowType) => {
    try {
            ...
            {isExpanded ? (
              <div>
                ...
                <ul className="list-disc list-outside md:pl-12 sm:pl-6">
                  ...
                  <li className="pl-2">
                    {" "}
                    Attend bi-monthly meetings to stay updated on planning
                    process
                  </li>
                  <li className="pl-2">
                    {" "}
                    Use word-of-mouth to publicize events
                  </li>
                  <li className="pl-2">
                    {" "}
                    Post flyers on school campuses and submit potential ideas
                    for the event via a form
                  </li>
                  <li className="pl-2">
                    {" "}
                ...
                <ul className="list-disc list-outside md:pl-12 sm:pl-6">
                  ...
                  <li className="pl-2">
                    {" "}
                    Applicants will be screened by the {`health{hacks}`}{" "}
                    executive team based on the information provided in the
                    form. You will be contacted via email regarding the status
                    of your application with 2 weeks of your submission.
                  </li>
                </ul>
                <br />
              ...
              <form>
                ...
                <div className="flex space-x-6">
                  <div className="w-[50vw]">
                    <ApplicationInput
                      ...
                      setValue={(value) =>
                        setTeamForm({ ...teamForm, firstName: value })
                      }
                      label="First Name"
                    />
                  </div>
                ...
                <div className="flex space-x-6">
                  <div className="w-[50vw]">
                    <ApplicationInput
                      ...
                      setValue={(value) =>
                        setTeamForm({ ...teamForm, email: value })
                      }
                      label="Email"
                    />
                  </div>
                ...
                <div>
                  <ApplicationInput
                    ...
                    setValue={(value) =>
                      setTeamForm({ ...teamForm, background: value })
                    }
                ...
                <div>
                  <p
                    className={`mt-8 -mb-6 lg:text-lg md:text-small font-semibold ${
                      error[5].length > 0 ? "text-red-400" : "text-white"
                    }`}
                  >
                    Why do you want to be an ambassador for {`health{hacks}`}?
                    (Max 100 words)
                  </p>
                  <ApplicationInput
                    textarea
                    ...
                    value={teamForm.why}
                    setValue={(value) =>
                      setTeamForm({ ...teamForm, why: value })
                    }
                  />
                </div>
                ...
                <div>
                  <p className="mt-8 -mb-6 lg:text-lg md:text-small font-semibold">
                    Do you have any experience with marketing/publicity? If yes,
                    please explain more. (Max 100 words)
                  </p>
                  <ApplicationInput
                    textarea
                    placeholder=""
                    ...
                    setValue={(value) =>
                      setTeamForm({ ...teamForm, experience: value })
                    }
                  />
                </div>
                ...
                <div>
                  <ApplicationInput
                    ...
                    setValue={(value) =>
                      setTeamForm({ ...teamForm, linkedin: value })
                    }
                ...
                <div>
                  ...
                  <ApplicationInput
                    ...
                    setValue={(value) =>
                      setTeamForm({ ...teamForm, other: value })
                    }
                  />
                </div>
              </form>

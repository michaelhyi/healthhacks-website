...
exports.registeredHTML = exports.whitelistedHTML = exports.attendeeConfirmationHTML = exports.forgotPaswordHTML = exports.applicationConfirmationHTML = exports.verifyHTML = void 0;
...
exports.applicationConfirmationHTML = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html
...
exports.forgotPaswordHTML = forgotPaswordHTML;
exports.attendeeConfirmationHTML = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html
  xmlns="http://www.w3.org/1999/xhtml"
  xmlns:v="urn:schemas-microsoft-com:vml"
  xmlns:o="urn:schemas-microsoft-com:office:office"
                              ...
                              <tbody>
                                <tr>
                                  <td
                                    ...
                                    align="center"
                                  >
                                    Thank you for confirming your spot to attend health{hacks}! Be on the lookout for
                                    some more information closer to the event.
                                    
                                    <br/><br/>If you have any questions, please email <a href="mailto:info@joinhealthhacks.com">info@joinhealthhacks.com</a>&nbsp;
                                  </td>
                                </tr>
                                <tr>
                                  <td
...
`;
exports.whitelistedHTML = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <!--[if !mso]><!-->
                      ...
                      <tr>
                        <td class="pc-sm-p-35-30 pc-xs-p-25-20" style="padding: 40px; background-color: #ffffff; border-radius: 8px;" valign="top" bgcolor="#ffffff">
                          <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-xs-fs-30 pc-xs-lh-42 pc-fb-font" style="font-family: 'Inter', Helvetica, Arial, sans-serif; font-size: 36px; font-weight: 900; line-height: 46px; letter-spacing: -0.6px; color: #151515; text-align: center" valign="top">Welcome to health{hacks} 2023 @ Stanford!</td>
                              </tr>
                              <tr>
                                <td height="10" style="font-size: 1px; line-height: 1px;">&nbsp;</td>
                              </tr>
                            ...
                            <tbody>
                              <tr>
                                <td class="pc-fb-font" style="font-family: 'Inter', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 300; line-height: 28px; color: #1B1B1B; letter-spacing: -0.2px" valign="top" align="center">                                    It's our pleasure to welcome you to our event on April 14 - 16th, 2023 at the 
                                  Stanford Jen-Hsun Huang Engineering Center.
                                  
                                  <br/><br/>To confirm your spot, please fill out this quick form here:&nbsp;</td>
                              </tr>
                              <tr>
                                <td height="15" style="font-size: 1px; line-height: 1px;">&nbsp;</td>
                              </tr>
                                ...
                                <td style="padding: 5px 0;" valign="top" align="center">
                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                    <tbody>
                                      <tr>
                                        <td style="padding: 13px 17px; border-radius: 8px; background-color: #8d58b0" bgcolor="#8d58b0" valign="top" align="center">
                                          <a href="${process.env.ORIGIN}/confirm" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Inter', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff">Confirm Your Spot</a>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                ...
                                <td style="padding: 5px 0;" valign="top" align="center">
                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                    <tbody>
                                      <tr>
                                        <td style="padding: 13px 17px; border-radius: 8px; background-color: #8d58b0" bgcolor="#8d58b0" valign="top" align="center">
                                          <a href="${process.env.ORIGIN}/registered/?id=${token}" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Inter', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff">Confirm Your Spot</a>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
...
exports.registeredHTML = registeredHTML;

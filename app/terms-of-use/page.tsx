      ...
      <div className="lg:mt-24 md:mt-20 sm:mt-8 mb-24 lg:mx-40 md:mx-16 sm:mx-12">
        ...
        <div>
          ...
          <div className="font-thin text-sm">
            ...
            <strong>(&quot;you&quot;)</strong> and healthhacks LLC
            <strong>
              (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or
              &quot;our&quot;)
            </strong>
            , concerning your access to and use of the joinhealthhacks.com
            website as well as any other media form, media channel, mobile
            website or mobile application related, linked, or otherwise
            connected thereto (collectively, the “Site”). We are registered in
            California, United States and have our registered office at 4032
            Rampage Ln, Irvine, CA 92620. You agree that by accessing the Site,
            ...
            to receives pecific notice of each such change. Please ensure that
            you check the applicable Terms every time you use our Site so that
            you understand which Terms apply. Youwill be subject to, and will be
            deemed to have been made aware of and to haveaccepted, the changes
            in any revised Terms of Use by your continued use of the Siteafter
            the date such revised Terms of Use are posted.
            <br />
            <br />
            The information provided on the Site is not intended for
            distribution to or use by anyperson or entity in any jurisdiction or
            country where such distribution or use would becontrary to law or
            regulation or which would subject us to any registrationrequirement
            within such jurisdiction or country. Accordingly, those persons
            whochoose to access the Site from other locations do so on their own
            initiative and aresolely responsible for compliance with local laws,
            if and to the extent local laws areapplicable.
            <br />
            <br />
            The Site is not tailored to comply with industry-specific
            regulations (Health Insurance Portability and Accountability Act
            (HIPAA), Federal Information Security ManagementAct (FISMA), etc.),
            ...
            users who areminors in the jurisdiction in which they reside
            (generally under the age of 18) musthave the permission of, and be
            directly supervised by, their parent or guardian to usethe Site. If
            you are a minor, you must have your parent or guardian read and
            agree tothese Terms of Use prior to you using the Site.
          </div>
        </div>
        ...
        <div className="font-thin text-sm">
          ...
          (collectively, the “Content”) and the trademarks, servicemarks, and
          logos contained therein (the “Marks”) are owned or controlled by us
          orlicensed to us, and are protected by copyright and trademark laws
          ...
          international conventions. The Content and theMarks are provided on
          ...
          noContent or Marks may be copied, reproduced, aggregated, republished,
          uploaded, posted, publicly displayed, encoded, translated,
          transmitted, distributed, sold,licensed, or otherwise exploited for
          any commercial purpose whatsoever, without ourexpress prior written
          permission.
          <br />
          <br />
          Provided that you are eligible to use the Site, you are granted a
          limited license toaccess and use the Site and to download or print a
          copy of any portion of the Content to which you have properly gained
          access solely for your personal, non-commercial use. We reserve all
          rights not expressly granted to you in and to the Site, the Contentand
          the Marks.
        </div>
        ...
        <div className="font-thin text-sm">
          ...
          registration information yousubmit will be true, accurate, current,
          and complete; (2) you will maintain theaccuracy of such information
          and promptly update such registration information asnecessary; (3) you
          have the legal capacity and you agree to comply with these Termsof
          Use; (4) you are not under the age of 13; (5) you are not a minor in
          ...
          otherwise; (7) you will not use the Site for any illegalor
        ...
        <div className="font-thin text-sm">
          ...
          account and password. Wereserve the right to remove, reclaim, or
          change a username you select if wedetermine, in our sole discretion,
        ...
        <div className="font-thin text-sm">
          ...
          which wemake the Site available. The Site may not be used in
          ...
          <ul className="list-disc list-outside md:pl-12 sm:pl-6">
            ...
            <li className="pl-2">
              ...
              attempt to learnsensitive account information such as user
              passwords.
            </li>
            <li className="pl-2">
              Circumvent, disable, or otherwise interfere with security-related
              features of theSite, including features that prevent or restrict
              the use or copying of anyContent or enforce limitations on the use
              of the Site and/or the Contentcontained therein.
            </li>
            <li className="pl-2">
            ...
            <li className="pl-2">
              ...
              abuse, or harmanother person.
            </li>
            <li className="pl-2">
              Make improper use of our support services or submit false reports
              of abuse ormisconduct.
            </li>
            <li className="pl-2">
            ...
            <li className="pl-2">
              ...
              to sendcomments or messages, or using any data mining, robots, or
              similar datagathering and extraction tools.
            </li>
            <li className="pl-2">
            ...
            <li className="pl-2">
              ...
              material that actsas a passive or active information collection or
            ...
            <li className="pl-2">
              ...
              the networksor services connected to the Site.
            </li>
            <li className="pl-2">
              Harass, annoy, intimidate, or threaten any of our employees or
              agentsengaged in providing any portion of the Site to you.
            </li>
            <li className="pl-2">
              Attempt to bypass any measures of the Site designed to prevent or
              restrictaccess to the Site, or any portion of the Site.
            </li>
            <li className="pl-2">
            ...
            <li className="pl-2">
              ...
              in any way making up apart of the Site.
            </li>
            <li className="pl-2">
              Except as may be the result of standard search engine or Internet
              browserusage, use, launch, develop, or distribute any automated
              system, includingwithout limitation, any spider, robot, cheat
            ...
            <li className="pl-2">
              ...
              use the Siteand/or the Content for any revenue-generating endeavor
            ...
            <li className="pl-2">
              ...
              without authorization from that person and the Company, or create
              a false identity on the Services.
            </li>
            <li className="pl-2">
              Upload, post, transmit, share, store or otherwise make available
        ...
        <div className="font-thin text-sm">
          ...
          transmission, public display, or performance, and theaccessing,
          downloading, or copying of your Contributions do not and will
          notinfringe the proprietary rights, including but not limited to the
          ...
          authorize us, the Site, andother users of the Site to use your
          Contributions in any manner contemplatedby the Site and these Terms of
          ...
          <ul className="list-disc list-outside md:pl-12 sm:pl-6">
            ...
            <li className="pl-2">
              ...
              that violates, anyprovision of these Terms of Use, or any
              applicable law or regulation.
            </li>
          </ul>
          <br /> <br />
          Any use of the Site in violation of the foregoing violates these Terms
          of Use and mayresult in, among other things, termination or suspension
        ...
        <div className="font-thin text-sm">
          ...
          grant, and you represent and warrant thatyou have the right to grant,
          to us an unrestricted, unlimited, irrevocable, perpetual,
          non-exclusive, transferable, royalty-free, fully-paid, worldwide
          right, and license tohost, use, copy, reproduce, disclose, sell,
        ...
        <div className="font-thin text-sm">
          ...
          with online accountsyou have with third-party service providers (each
          such account, a “Third-PartyAccount”) by either: (1) providing your
          ...
          underthe applicable terms and conditions that govern your use of each
          ...
          makingus subject to any usage limitations imposed by the third-party
          ...
          provided to and stored in your Third-Party Account (the “SocialNetwork
          ...
          with the Third-Party Account. Depending on the Third-PartyAccounts you
          choose and subject to the privacy settings that you have set in
          suchThird-Party Accounts, personally identifiable information that you
          post to your Third-Party Accounts may be available on and through your
          account on the Site. Pleasenote that if a Third-Party Account or
          associated service becomes unavailable or ouraccess to such Third
          ...
          account on the Siteand your Third-Party Accounts at any time. PLEASE
          NOTE THAT YOURRELATIONSHIP WITH THE THIRD-PARTY SERVICE PROVIDERS
          ASSOCIATEDWITH YOUR THIRD-PARTY ACCOUNTS IS GOVERNED SOLELY BY
          YOURAGREEMENT(S) WITH SUCH THIRD-PARTY SERVICE PROVIDERS. We make
          noeffort to review any Social Network Content for any purpose,
          including but not limitedto, for accuracy, legality, or
        ...
        <div className="font-thin text-sm">
          ...
          (&quot;Submissions&quot;) provided by you tous are non-confidential
        ...
        <div className="font-thin text-sm">
          ...
          Notification will be sent to the person who posted restored the
        ...
        <div className="font-thin text-sm">
          ...
          inability to access or use theSite during any downtime or
        ...
        <div className="font-thin text-sm">
          THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREETHAT
          YOUR USE OF THE SITE AND OUR SERVICES WILL BE AT YOUR SOLERISK. TO THE
          ...
          TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SITE. WE DON&apos;T
          WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT
          OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTYTHROUGH THE SITE, ANY
        ...
        <div className="font-thin text-sm">
          ...
          OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR $0.00 USD. CERTAIN US
        ...
        <div className="font-thin text-sm">
          ...
          partners, and employees, for and against any loss, damage, liability,
        ...
        <div className="font-thin text-sm">
          ...
          purpose ofmanaging the performance of the Site, as well as data
          relating to your use of the Site.Although we perform regular routine
          backups of data, you are solely responsible forall data that you
          transmit or that relates to any activity you have undertaken using
          theSite. You agree that we shall have no liability to you for any loss
          or corruption of anysuch data, and you hereby waive any right of
          action against us arising from any suchloss or corruption of such
          data.
        </div>
        ...
        <div className="font-thin text-sm">
          ...
          any right or provision of these Terms of Useshall not operate as a

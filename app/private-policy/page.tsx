    ...
    <ContainerApp>
      <div className="lg:mt-24 md:mt-20 sm:mt-8 mb-24 lg:mx-40 md:mx-16 sm:mx-12">
        ...
        <div className="font-thin text-sm">
          This privacy notice for healthhacks LLC (
          <strong>&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; </strong>{" "}
          ...
          <ul className="list-disc list-outside md:pl-12 sm:pl-6">
            <li className="pl-2">
              {" "}
              Visit our website at https://joinhealthhacks.com, or any website
          ...
          us at info@joinhealthhacks.com.
        </div>

        <h2 className="font-semibold text-xl mt-8">SUMMARY OF KEY POINTS</h2>
        <div className="font-thin text-sm">
          <br />
          <strong>
          ...
          information depending on how you interact with healthhacks LLC and the
        ...
        <div>
          ...
          <div className="font-thin text-sm">
            ...
            Protocol (IP) address and/browser and device characteristics — is
            collected automatically when you visit ourServices.
            <br />
            We automatically collect certain information when you visit, use, or
            navigate the Services. This information does not reveal your
            specific identity (like your name or contact information) but may
            include device and usage information, such as your IPaddress,
            ...
            log data may include your IP address, deviceinformation, browser
        ...
        <div className="font-thin text-sm">
          ...
          <ul className="list-disc list-outside md:pl-12 sm:pl-6">
            <li className="pl-2">
              ...
              We may process your information so you can create and login to
            ...
            <li className="pl-2">
              ...
              For more information, see &quot;WHAT ARE YOUR PRIVACY
              RIGHTS?&quot; below).
            </li>
            <li className="pl-2">
        ...
        <div className="font-thin text-sm">
          ...
          <ul className="list-disc list-outside md:pl-12 sm:pl-6">
            ...
            <li className="pl-2">
              ...
              to investigating a breach of an agreement or contravention of the
              laws of Canada or a province
            </li>
            <li className="pl-2">
              If disclosure is required to comply with a subpoena, warrant,
              court order, rules of the court relating to the production of
              records
            </li>
            <li className="pl-2">
        ...
        <div className="font-thin text-sm">
          ...
          share personal information with are as follows: Event Sponsors We also
          ...
          <ul className="list-disc list-outside md:pl-12 sm:pl-6">
            ...
            <li className="pl-2">
              <b>Event Sponsors and Business Partners.</b> We may share your
        ...
        <div className="font-thin text-sm">
          ...
          personal information has been stored in backuparchives), then we will
        ...
        <div className="font-thin text-sm">
          ...
          and efforts to secure your information, non electronic transmission
          over the Internet or information storage technology can be guaranteed
          to be 100% secure, so we cannot promise or guarantee that hackers,
          cybercriminals, or other unauthorized third parties will not be able
          to defeat our security and improperly collect, access, steal, or
          ...
          our Services is at your own risk. You should only access theServices
        ...
        <div className="font-thin text-sm">
          ...
          consent to such minor dependents use of theServices. If we learn that
          ...
          contact us at info@joinhealthhacks.com.
        </div>
        ...
        <div className="font-thin text-sm">
          ...
          portability. Uncertain circumstances, you may also have the right to
          ...
          in section &quot;HOW CAN YOU CONTACT US ABOUT THIS NOTICE?&quot;
          ...
          use of your account, to respond to service requests, or for
          othernon-marketing purposes.
          <br />
          <br />
          ...
          However, we may retain someinformation in our files to prevent fraud,
          troubleshoot problems, assist with any investigations, enforce our
          legal terms and/or comply with applicable legal requirements.
          <br />
          <br />
          If you have questions or comments about your privacy rights, you may
          email us atinfo@joinhealthhacks.com.
        </div>
        ...
        <div className="font-thin text-sm">
          ...
          individuals are defined as &quot;non-residents.&quot; If this
          definition of &quot;resident&quot; applies to you, we must adhere to
          ...
          be found in this privacy notice. You can opt out from the selling or
          sharing of your personal information by disabling cookies in Cookie
          Preference Settings and clicking on the Do Not Sell or Share
          MyPersonal Information link on our homepage. You may contact us by
          email at info@joinhealthhacks.com, or by referring to the contact
          ...
          pursuant to written contract between us and each service provider.
          Each service provider is a for-profit entity that processes the
          information on our behalf, following the same strict privacy
          protection obligations mandated by the CCPA. We may use your personal
          ...
          information.healthhacks LLC has disclosed the following categories of
          ...
          &quot;WHEN AND WITH WHOM DOWE SHARE YOUR PERSONAL
          INFORMATION?&quot;.healthhacks LLC has sold or shared the following
          ...
          verify your identity authority to make the request. To the extent
          ...
          your behalf in accordance with the CCPA. To exercise these rights, you
          can contact us by email at info@joinhealthhacks.com,or by referring to
        ...
        <div className="font-thin text-sm">
          ...
          at info@joinhealthhacks.com or by post to:
          <strong>
            <br /> <br />
            healthhacks LLC
            <br />
        ...
        <div className="font-thin text-sm">
          ...
          change that information, ordelete it. To request to review, update, or
          delete your personal information, please email us as
          info@joinhealthhacks.com
        </div>
      </div>
      <Footer />

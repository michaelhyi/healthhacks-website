...
const Statistics = () => {
  return (
    <Fade delay={500}>
      {/* sm:space-y-12  */}
      <div className="flex items-center justify-center sm:flex-col  md:flex-row xl:space-y-0 xl:space-x-12 2xl:space-x-16 text-center border-y-[0.5px] border-white border-opacity-25 py-8 bg-hh-gray shadow-md shadow-hh-gray">
